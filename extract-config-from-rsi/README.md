...
```
python3 "C:\Users\user\Documents\Coding\Python\script-to-extract-config-from-rsi\extract-config-script.py" "C:\Users\user\Documents\Coding\Python\script-to-extract-config-from-rsi\test-rsi.txt" "config-file"
```
